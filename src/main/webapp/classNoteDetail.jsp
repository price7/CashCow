		...
		<div id="student1">
			<form id="tle">
				...
				<div id="alter_btn" align="right">
					<a href="classNoteModify.jsp?NoteNo=<%=vo.getNoteNo()%>"><button class="btn btn-warning btn-xs" type="button" id="" >수정</button></a>
					<a href="classNoteDeleteOk.jsp?NoteNo=<%=vo.getNoteNo()%>"><button class="btn btn-warning btn-xs" type="button" id="" >삭제</button></a>
